        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-20">
          ...
          <div className="w-full md:w-7/12 text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto justify-center md:justify-start">
              <Link href="/katalog" className="bg-red-800 text-white px-8 py-3.5 md:py-3 rounded-full text-sm md:text-base font-bold hover:bg-red-900 transition shadow-md text-center w-full sm:w-auto">
                Shop the Collection
              </Link>
              <Link href="/katalog" className="bg-white/80 md:bg-transparent border border-gray-400 text-gray-700 px-8 py-3.5 md:py-3 rounded-full text-sm md:text-base font-bold hover:bg-white transition shadow-sm text-center w-full sm:w-auto">
                Explore Flavors
              </Link>
            </div>
          </div>
