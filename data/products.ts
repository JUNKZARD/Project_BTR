   ...
   //selai 145gr
    {
      ...
      description: "Sweet, tropical pink guava reduced slowly to capture its vibrant aroma and natural sweetness.",
      benefits: ["Non-GMO", "No Refined Sugar", "Vegan"],
    },
    {
    ...
    //selai 30gr (mini)
    {
      ...
      tag: "GIFT SET",
      img: "/Box of 3 (2).webp",
      description: "A delightful set of our most popular jams in miniature 30g jars. Perfect for gifting or tasting.",
      benefits: ["Non-GMO", "Vegan"],
    },
    {
